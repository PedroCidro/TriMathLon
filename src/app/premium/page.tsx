...
export default function PremiumPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            {/* Hero */}
            <section className="flex-1 flex flex-col items-center px-6 pt-20 pb-16">
                <div className="max-w-2xl mx-auto text-center space-y-6">
                    ...
                    <p className="text-xl text-gray-500 max-w-lg mx-auto">
                        Acesso completo a todos os tópicos de Derivadas, Integrais e EDOs.
                    </p>
            ...
            <section className="bg-gray-50 px-6 py-20">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-gray-500 text-center mb-12 text-lg">
                        13 tópicos avançados em 3 módulos
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        {premiumTopics.map((mod) => {
                            ...
                            return (
                                <div key={mod.id} className={`bg-white rounded-2xl border-2 ${colors.border} p-6`}>
                    ...
                    <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 max-w-2xl mx-auto">
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Disponível em todos os tópicos</p>
                            </div>
                        </div>
                        <p className="text-gray-500 ml-14">
                            Treine a identificação de qual técnica usar em cada problema — a habilidade mais importante nas provas.
                        </p>
                    </div>
                </div>
            </section>
